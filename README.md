...
This repository depends [on my Keras-2 branch](https://github.com/israelg99/keras/tree/keras-2) until it is merged with the official [Keras-2](https://github.com/fchollet/keras/tree/keras-2) repository.  
